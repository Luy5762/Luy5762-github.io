...
function main() {
    ...
    let sliders = [
        {id:"slider-thumb-joint1",  orientation:"vertical",   min:-10, max:90, value:0},
        {id:"slider-thumb-joint2",  orientation:"vertical",   min:-10, max:90, value:0},
        {id:"slider-index-joint1",  orientation:"vertical",   min:-10, max:90, value:0},
        {id:"slider-index-joint2",  orientation:"vertical",   min:-10, max:90, value:0},
        {id:"slider-index-joint3",  orientation:"vertical",   min:-10, max:90, value:0},
        {id:"slider-middle-joint1", orientation:"vertical",   min:-10, max:90, value:0},
        {id:"slider-middle-joint2", orientation:"vertical",   min:-10, max:90, value:0},
        {id:"slider-middle-joint3", orientation:"vertical",   min:-10, max:90, value:0},
        {id:"slider-ring-joint1",   orientation:"vertical",   min:-10, max:90, value:0},
        {id:"slider-ring-joint2",   orientation:"vertical",   min:-10, max:90, value:0},
        {id:"slider-ring-joint3",   orientation:"vertical",   min:-10, max:90, value:0},
        {id:"slider-small-joint1",  orientation:"vertical",   min:-10, max:90, value:0},
        {id:"slider-small-joint2",  orientation:"vertical",   min:-10, max:90, value:0},
        {id:"slider-small-joint3",  orientation:"vertical",   min:-10, max:90, value:0},
